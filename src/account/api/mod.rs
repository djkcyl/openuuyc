...
pub const BASE_URL: &str = crate::account::nrd_http::PRIMARY;
pub const PROTOCOL_VERSION: &str = crate::protocol::official_version::CLIENT;
...
impl RoomSession {
    pub(crate) fn from_assist(reply: &crate::account::assist::JoinReply) -> Self {
        Self {
...
#[derive(Clone)]
pub struct NrdApi {
    http: crate::account::nrd_http::NrdHttp,
...
impl NrdApi {
    pub fn new(identity: ClientIdentity) -> Result<Self> {
        let http = crate::account::nrd_http::NrdHttp::new()?;
        Ok(Self {
            http,
            identity,
        ...
        T: DeserializeOwned,
    {
        ...
        let (status, bytes) = self
            ...
            .send(
                ...
                contract.timeout,
                if single_attempt {
                    crate::account::nrd_http::RetryPolicy::Never
                } else {
                    crate::account::nrd_http::RetryPolicy::Recovery {
