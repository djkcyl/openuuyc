...
OpenUUYC 是使用 Rust 开发的 UU 远程第三方客户端，提供设备管理、远程画面观看和串流设置。当前主要支持 Windows，Linux 与 macOS 后端仍在完善中。
...
当前不提供键鼠控制、剪贴板、文件传输、本机被控、云设备或网络代理功能。AV1、NVDEC 和 HEVC 软件解码暂不支持。Linux/macOS 尚未完成实机验收。
