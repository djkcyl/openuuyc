...
fn test_candidate_marshal() -> Result<()> {
    let tests = vec![
       (
            ...
            "750 1 udp 500 fcd9:e3b8:12ce:9fc5:74a5:c6bb:d8b:e08a 53987 typ host generation 0 network-id 0 network-cost 50",
        ),
        (
            Some(CandidateBase{
                    network_type:   AtomicU8::new(NetworkType::Udp4 as u8),
            ...
            "4273957277 1 udp 2130706431 10.0.75.1 53634 typ host generation 0 network-id 0 network-cost 50",
        ),
        (
            Some(CandidateBase{
                    network_type:    AtomicU8::new(NetworkType::Udp4 as u8),
            ...
            "647372371 1 udp 1694498815 191.228.238.68 53991 typ srflx raddr 192.168.0.274 rport 53991 generation 0 network-id 0 network-cost 50",
        ),
        (
            Some(CandidateBase{
                    network_type:   AtomicU8::new(NetworkType::Udp4 as u8),
            ...
            "848194626 1 udp 16777215 50.0.0.1 5000 typ relay raddr 192.168.0.1 rport 5001 generation 0 network-id 0 network-cost 50",
        ),
        (
            Some(CandidateBase{
                    network_type:   AtomicU8::new(NetworkType::Tcp4 as u8),
            ...
            "1052353102 1 tcp 2128609279 192.168.0.196 0 typ host tcptype active generation 0 network-id 0 network-cost 50",
        ),
        (
            Some(CandidateBase{
                    network_type:   AtomicU8::new(NetworkType::Udp4 as u8),
            ...
            "1380287402 1 udp 2130706431 e2494022-4d9a-4c1e-a750-cc48d4f8d6ee.local 60542 typ host generation 0 network-id 0 network-cost 50",
        ),
        // Invalid candidates
        (None, ""),
        (None, "1938809241"),
