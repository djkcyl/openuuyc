...
impl GoogCcNetworkController {
    /// UU's detector augments loss backoff; delay-based overuse remains active.
    pub fn set_random_loss_no_backoff(&mut self, random_loss: bool) {
        self.bandwidth_estimation
            .set_random_loss_no_backoff(random_loss);
    }
    pub fn delay_state(&self) -> BandwidthUsage {
    ...
    pub fn bounded_target_rate(&self) -> DataRate {
        self.bandwidth_estimation.bounded_target_rate()
    }
